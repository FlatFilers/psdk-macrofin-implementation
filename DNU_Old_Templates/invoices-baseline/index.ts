...
export const Invoices_BASELINE = new Sheet(
  'Invoices BASELINE',
  {
    ...
    tranId: TextField({
      label: 'Invoice #',
      description:
        '(need requiredWith/lookup logic) Enter Invoice number. This field should be unique. Not required if Auto-Generated number will be used',
      required: true,
    }),
